...
int main()
{
    ...
    printf("\nEnter the Id of Student 2 : ");    scanf("%d", &b2.Id);
    ...
    printf("\nEnter the Id of Student 3 : ");    scanf("%d", &b3.Id);
    ...
    printf("\nEnter the Id of Student 4 : ");    scanf("%d", &b4.Id);
    ...
    printf("\nEnter the Id of Student 5 : ");    scanf("%d", &b5.Id);
